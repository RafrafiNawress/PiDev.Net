    ...
    public partial class Context : DbContext
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<competency>()
                ...
                .Map(m => m.ToTable("competency_employee").MapLeftKey("competencies_id").MapRightKey("employees_id"));
            ...
            modelBuilder.Entity<job>()
                ...
                .WithMany(e => e.jobs)
                .Map(m => m.ToTable("competency_job").MapLeftKey("jobs_id").MapRightKey("competencies_id"));
